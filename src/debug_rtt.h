...
// a new enum value.
    ...
    typedef enum _bp_debug_category_enum_t {
        ...
        E_DEBUG_CAT_ONBOARD_STORAGE  =  3u, // (((uint32_t)1u) <<  3u), // onboard flash storage
        E_DEBUG_CAT_OTP              =  4u, // (((uint32_t)1u) <<  4u), // OTP functions
...
#define BP_DEBUG_CAT_OTP              ((bp_debug_category_t){ E_DEBUG_CAT_OTP              }) // OTP functions
