...
// a new enum value.
    ...
    typedef enum _bp_debug_category_enum_t {
        ...
        E_DEBUG_CAT_ONBOARD_STORAGE  =  3u, // (((uint32_t)1u) <<  3u), // lcdi2c mode specific
        E_DEBUG_CAT_OTP              =  4u, // (((uint32_t)1u) <<  4u), // rp2350 OTP (fuse) settings
        E_DEBUG_CAT_CERTIFICATE      =  5u, // (((uint32_t)1u) <<  5u), // certificate handling
...
#define BP_DEBUG_CAT_CERTIFICATE      ((bp_debug_category_t){ E_DEBUG_CAT_CERTIFICATE      }) // certificate handling
